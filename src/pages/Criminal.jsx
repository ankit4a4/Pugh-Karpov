...
import FamilyLawSection from '../components/bankruptcy/FamilyLawSection';
    ...
    return (
        <div className="min-h-screen bg-gray-50 px-4 py-8 md:mt-20">
            <div className="flex justify-center  mt-10 md:mt-30 gap-4 mb-10 flex-wrap">
                ...
                <button
                    className={`text-[1.8vh] md:text-[1.2vw] px-6 py-2 rounded-full transition-all duration-300 font-semibold shadow-md cursor-pointer text-white border bg-blue-700 border-blue-700 "
              }`}
